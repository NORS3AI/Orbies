...
- **⚔️ Arena** — One **continuous 100-rung leaderboard** you climb from the **bottom (#100) toward #1**. You're slotted in by **arena points** with a highlighted **(you)** row (the board auto-centers on you), the top three seats are gilded, and every entry shows its avatar, handle, DPS and points. Hit **CHALLENGE** (costs **1 flag**, colour-coded green/yellow/red by matchup) to fight the rival **directly above** you: a full **battle screen** opens where your Orbies (left) trade blows with theirs (right) **one Orbie per turn**, striking the front-most enemy until one team is wiped — with a **2× speed** button to fast-forward. A results card then tallies each side's **total damage**, **team DPS** and survivors. **You only ever fight up** — a win climbs you **whole rungs** (1 for a scrape, up to 8 for a flawless win) and your rank **never resets down**; your metal badge (**Bronze → Diamond**, 15 metals × 10 tiers) upgrades as you rise. Each Orbie has **health** scaled by its rarity and level. You hold **5 challenge flags** that regenerate **1 every 2 minutes**; the NPC roster **reshuffles its faces every 2 hours** but the ladder itself stays put, so your position only moves when *you* fight.
