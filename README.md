...
- **🪨 Auto-Battle** — You **can't tap the rock**. Your Orbies do the work: they take turns striking it for DPS, **up to 8 at a time**. Each floor has **10 rocks**, and rock HP climbs on a gentle **additive** curve — **+2 per rock** as you clear a floor, and **+10 more per new floor**.
...
- **✨ Level & Evolve** — Spend treats to level up. At **Lv 20** an Orbie can **evolve**, and at **Lv 50** it evolves into its **final form**. Each evolution jumps it **+2 rarities** above its previous form **and multiplies its HP & DPS** — the first evolution **doubles** them, and the final form is **×2.5 more** (so a fully-evolved Orbie hits ×5 its base stats). Evolving your maxed keepers is the path to the top of the Arena.
...
- **🔁 Auto-Open, only when you choose** — Auto-Open opens **just the orbs you have when you start it**. It keeps going **in the background** across tabs and while the menu is closed, so a big pile still finishes if you navigate away, pausing only to ask when your hold is full — then it **stops**. Orbs that arrive later (from **orb-seed harvests**, chests, or descending) **stay closed** until you choose to Auto-Open again. Orbies never open on their own.

- **⚔️ Arena** — One **continuous 100-rung leaderboard** you climb from the **bottom (#100) toward #1** by banking **arena points**. You're slotted in by your total points with a highlighted **(you)** row (the board auto-centers on you), the top three seats are gilded, and every entry shows its avatar, handle, DPS and score. Above the ladder is a **swipeable strip of the next ~10 rivals directly above you** — you **choose who to fight**. Each rival card shows its DPS, a **difficulty colour** (green/yellow/red, by matchup), and a **point reward that grows the higher you reach**: the rival right above pays **+1**, and each rung further up pays one more, up to **+5**. Higher rungs hit harder, so the tougher rivals in your list are worth more — play it safe near you for a little, or **reach up to a deadlier rival for up to +5** (at a real risk of losing). Tapping a card (costs **1 flag**) opens a full **battle screen** where your Orbies (left) trade blows with theirs (right) **one Orbie per turn**, striking the front-most enemy until one team is wiped — with a **2× speed** button to fast-forward. Points only ever accumulate, so **you only ever fight up** — your rank never resets down, and your metal badge (**Bronze → Diamond**, 15 metals × 10 tiers) upgrades as you rise. Combat difficulty climbs steeply with rank, so the top of the ladder is a real wall. Each Orbie has **health** scaled by its rarity and level. You hold **5 challenge flags** that regenerate **1 every 2 minutes**; the NPC roster **reshuffles its faces every 2 hours** but the ladder itself stays put, so your position only moves when *you* fight.
- **🛒 Shop** — A tab to spend gold: buy orbs (one or ten at a time) and expand your Orbie hold on the escalating price curves, grab flat-rate **orb chests** (100g→25, 250g→60, 500g→150, 1000g→500 orbs), and buy a one-time **⏬ Auto-Descend** unlock (10,000g) that auto-taps the **Descend** button so you rip through a floor's rocks straight to the boss. Once-only unlocks vanish from the shop after purchase.
- **🧙 You** — A profile tab. **Rename** your handle (spaces auto-become hyphens) and pick your **player icon** from any Orbie you're holding or have ever hatched — the icon and name show up as your **(you)** row in the Arena. It also tracks how many of the Orbie species you've **discovered**.
